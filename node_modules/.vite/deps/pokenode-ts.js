...
var t = Number;
function s(s3) {
  var n4 = Object.defineProperty({}, e, { enumerable: false, value: 1 });
  if (!s3 || "string" != typeof s3)
    return n4;
  var i3 = function(e3) {
    var a2 = {}, r4 = e3.toLowerCase().replace(/\s+/g, "").split(",");
    for (var t3 in r4) {
      var s4, n5 = r4[t3].split("=", 2);
      a2[n5[0]] = null == (s4 = n5[1]) || s4;
    }
    return a2;
  }(s3), u3 = i3["max-age"], l3 = i3["max-stale"], o3 = i3["min-fresh"], m3 = i3["s-maxage"], p3 = i3["stale-if-error"], h3 = i3["stale-while-revalidate"];
  return r(i3.immutable) && (n4.immutable = true), a(u3) && (n4.maxAge = t(u3)), a(l3) && (n4.maxStale = t(l3)), a(o3) && (n4.minFresh = t(o3)), r(i3["must-revalidate"]) && (n4.mustRevalidate = true), r(i3["must-understand"]) && (n4.mustUnderstand = true), r(i3["no-cache"]) && (n4.noCache = true), r(i3["no-store"]) && (n4.noStore = true), r(i3["no-transform"]) && (n4.noTransform = true), r(i3["only-if-cached"]) && (n4.onlyIfCached = true), r(i3.private) && (n4.private = true), r(i3["proxy-revalidate"]) && (n4.proxyRevalidate = true), r(i3.public) && (n4.public = true), a(m3) && (n4.sMaxAge = t(m3)), a(p3) && (n4.staleIfError = t(p3)), a(h3) && (n4.staleWhileRevalidate = t(h3)), n4;
}

// node_modules/fast-defer/dist/index.mjs
var r2 = Symbol();
function e2() {
  var e3, n4, o3 = new Promise(function(r4, o4) {
    e3 = r4, n4 = o4;
  });
  return o3.resolve = e3, o3.reject = n4, o3[r2] = 1, o3;
}
...
function t2(n4, e3) {
  ...
  var r4 = typeof n4;
  if (n4 && "object" === r4 && !(n4 instanceof Date || n4 instanceof RegExp)) {
    for (var o3 = Array.isArray(n4) ? [] : {}, i3 = Object.keys(n4).sort(function(t3, n5) {
      return t3 > n5 ? 1 : -1;
    }), a2 = i3.length; a2--; ) {
      var f3 = i3[a2], c3 = n4[f3];
      if ("object" == typeof c3 && null !== c3 && !(c3 instanceof Date || c3 instanceof RegExp)) {
        if (e3.has(c3))
          continue;
        e3.set(c3, true);
      }
    ...
    return String(n4.constructor) + JSON.stringify(o3, i3);
  }
  return r4 + String(n4);
}
function n(n4) {
  n4 = t2(n4);
  for (var e3 = 5381, r4 = 0; r4 < n4.length; )
    e3 = 33 * e3 ^ n4.charCodeAt(r4++);
  return e3;
}
...
var n2 = (e3) => {
  ...
  if (t3) {
    const { noCache: a3, noStore: r4, maxAge: s3, maxStale: n4, immutable: d3, staleWhileRevalidate: c3 } = (0, o.parse)(String(t3));
    if (a3 || r4)
      return "dont cache";
    if (d3)
    ...
    if (void 0 !== s3) {
      const t4 = e3[i.Age];
      return { cache: t4 ? 1e3 * (s3 - Number(t4)) : 1e3 * s3, stale: void 0 !== n4 ? 1e3 * n4 : void 0 !== c3 ? 1e3 * c3 : void 0 };
    }
  }
...
function h(e3) {
  const t3 = async (a2) => {
    var r4, s3, o3, n4, f3, h3, g3, p3, v3, m3, w3, y3, S3, I3, x3;
    if (a2.id = e3.generateKey(a2), false === a2.cache)
      return a2;
    if (a2.cache = Object.assign(Object.assign({}, e3.defaults.cache), a2.cache), a2.cache.cacheTakeover && (null !== (r4 = (m3 = a2.headers)[w3 = i.CacheControl]) && void 0 !== r4 || (m3[w3] = "no-cache"), null !== (s3 = (y3 = a2.headers)[S3 = i.Pragma]) && void 0 !== s3 || (y3[S3] = "no-cache"), null !== (o3 = (I3 = a2.headers)[x3 = i.Expires]) && void 0 !== o3 || (I3[x3] = "0")), !u(a2.method, a2.cache.methods))
      return a2;
    let C3 = await e3.storage.get(a2.id, a2);
    const b3 = a2.cache.override;
    e:
      if ("empty" === C3.state || "stale" === C3.state || b3) {
        if (e3.waiting[a2.id] && !b3 && (C3 = await e3.storage.get(a2.id, a2), "empty" !== C3.state)) {
          0;
          break e;
        }
        return e3.waiting[a2.id] = (0, d.deferred)(), e3.waiting[a2.id].catch(() => {
        }), await e3.storage.set(a2.id, { state: "loading", previous: b3 ? C3.data ? "stale" : "empty" : C3.state, data: C3.data, createdAt: b3 && !C3.createdAt ? Date.now() : C3.createdAt }, a2), "stale" === C3.state && l(C3, a2), a2.validateStatus = c(a2.validateStatus), ("stale" === C3.state || C3.data) && await (null === (f3 = (n4 = a2.cache).hydrate) || void 0 === f3 ? void 0 : f3.call(n4, C3)), a2;
      }
    let A2;
    if ("loading" === C3.state) {
      const r5 = e3.waiting[a2.id];
      if (!r5)
        return C3.data && await (null === (g3 = (h3 = a2.cache).hydrate) || void 0 === g3 ? void 0 : g3.call(h3, C3)), a2;
      0;
      try {
        A2 = await r5;
      } catch (e4) {
        return C3.data && await (null === (v3 = (p3 = a2.cache).hydrate) || void 0 === v3 ? void 0 : v3.call(p3, C3)), t3(a2);
      }
    } else
      A2 = C3.data;
...
async function g(e3, t3) {
  ...
  if ("function" == typeof t3)
    return t3(e3);
  const { statusCheck: r4, responseMatch: s3, containsHeaders: o3 } = t3;
  if (r4 && !await r4(e3.status) || s3 && !await s3(e3))
    return false;
  if (o3) {
    for (const [t4, r5] of Object.entries(o3))
...
async function p(e3, t3, a2) {
  ...
  for (const [r4, s3] of Object.entries(a2)) {
    ...
    "delete" !== o3 ? "ignore" !== o3 && await e3.set(r4, o3, t3.config) : await e3.remove(r4, t3.config);
  }
}
function v(e3) {
  const t3 = async (t4, a3) => {
    ...
    const s3 = a3.config, o3 = s3.cache;
    if (a3.cached)
      return a3;
    if (!o3)
      return a3.cached = false, a3;
    if (o3.update && await p(e3.storage, a3, o3.update), !u(s3.method, o3.methods))
      return a3;
    const n4 = await e3.storage.get(a3.id, s3);
    if ("loading" !== n4.state)
      return a3;
    if (!n4.data && !await g(a3, o3.cachePredicate))
      return await t3(a3.id, s3), a3;
    for (const e4 of Object.keys(a3.headers))
      e4.startsWith("x-axios-cache") && delete a3.headers[e4];
    o3.etag && true !== o3.etag && (a3.headers[i.XAxiosCacheEtag] = o3.etag), o3.modifiedSince && (a3.headers[i.XAxiosCacheLastModified] = true === o3.modifiedSince ? "use-cache-timestamp" : o3.modifiedSince.toUTCString());
    let d3, c3 = o3.ttl || -1;
    if (o3.interpretHeader) {
      const r6 = e3.headerInterpreter(a3.headers);
      if ("dont cache" === r6)
        return await t3(a3.id, s3), a3;
      "not enough headers" !== r6 && ("number" == typeof r6 ? c3 = r6 : (c3 = r6.cache, d3 = r6.stale));
    }
    const l3 = f(a3, n4.data);
    "function" == typeof c3 && (c3 = await c3(a3)), o3.staleIfError && (a3.headers[i.XAxiosCacheStaleIfError] = String(c3));
    const h3 = { state: "cached", ttl: c3, staleTtl: d3, createdAt: Date.now(), data: l3 }, v3 = e3.waiting[a3.id];
    return v3 && (v3.resolve(h3.data), delete e3.waiting[a3.id]), await e3.storage.set(a3.id, h3, s3), a3;
  }, r4 = async (a3) => {
    var r5;
    if (!a3.isAxiosError || !a3.config)
      throw a3;
    const s3 = a3.config, n4 = s3.id, d3 = s3.cache, c3 = a3.response;
    if (!d3 || !n4)
      throw a3;
    if (!u(s3.method, d3.methods))
      throw await t3(n4, s3), a3;
    const l3 = await e3.storage.get(n4, s3);
    if ("loading" !== l3.state || "stale" !== l3.previous)
      throw await t3(n4, s3), a3;
    if (d3.staleIfError) {
      const t4 = String(null == c3 ? void 0 : c3.headers[i.CacheControl]), u3 = t4 && (0, o.parse)(t4).staleIfError, f3 = "function" == typeof d3.staleIfError ? await d3.staleIfError(c3, l3, a3) : true === d3.staleIfError && u3 ? 1e3 * u3 : d3.staleIfError;
      if (true === f3 || "number" == typeof f3 && l3.createdAt + f3 > Date.now())
        return null === (r5 = e3.waiting[n4]) || void 0 === r5 || r5.resolve(l3.data), delete e3.waiting[n4], await e3.storage.set(n4, { state: "stale", createdAt: Date.now(), data: l3.data }, s3), { cached: true, config: s3, id: n4, data: l3.data.data, headers: l3.data.headers, status: l3.data.status, statusText: l3.data.statusText };
    }
    throw await t3(n4, s3), a3;
  };
...
function I({ set: e3, find: t3, remove: a2 }) {
  return { "is-storage": 1, set: e3, remove: a2, get: async (r4, s3) => {
    ...
    if ("cached" === o3.state) {
      ...
      o3 = { state: "stale", createdAt: o3.createdAt, data: o3.data, ttl: void 0 !== o3.staleTtl ? o3.staleTtl + o3.ttl : void 0 }, await e3(r4, o3, s3);
    }
    return S(o3) ? w(o3) ? o3 : (await a2(r4, s3), { state: "empty" }) : o3;
  } };
}
...
function O(e3, t3 = {}) {
  var a2, r4, s3, o3, i3, d3, c3, u3;
  const l3 = e3;
  if (l3.defaults.cache)
    throw new Error("setupCache() should be called only once");
  if (l3.storage = t3.storage || x(), !m(l3.storage))
    throw new Error("Use buildStorage() function");
  return l3.waiting = t3.waiting || {}, l3.generateKey = t3.generateKey || E, l3.headerInterpreter = t3.headerInterpreter || n2, l3.requestInterceptor = t3.requestInterceptor || h(l3), l3.responseInterceptor = t3.responseInterceptor || v(l3), l3.debug = t3.debug || function() {
  }, l3.defaults.cache = { update: t3.update || {}, ttl: null !== (a2 = t3.ttl) && void 0 !== a2 ? a2 : 3e5, methods: t3.methods || ["get", "head"], cachePredicate: t3.cachePredicate || { statusCheck: (e4) => [200, 203, 300, 301, 302, 404, 405, 410, 414, 501].includes(e4) }, etag: null === (r4 = t3.etag) || void 0 === r4 || r4, modifiedSince: null !== (s3 = t3.modifiedSince) && void 0 !== s3 ? s3 : false === t3.etag, interpretHeader: null === (o3 = t3.interpretHeader) || void 0 === o3 || o3, cacheTakeover: null === (i3 = t3.cacheTakeover) || void 0 === i3 || i3, staleIfError: null === (d3 = t3.staleIfError) || void 0 === d3 || d3, override: null !== (c3 = t3.override) && void 0 !== c3 && c3, hydrate: null !== (u3 = t3.hydrate) && void 0 !== u3 ? u3 : void 0 }, l3.requestInterceptor.apply(), l3.responseInterceptor.apply(), l3;
}
...
var p2 = class extends o2 {
  async getBerryByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.BERRY}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getBerryFirmnessById(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.BERRY_FIRMNESS}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getBerryFlavorById(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.BERRY_FLAVOR}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  listBerries(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.BERRY, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  listBerryFirmnesses(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.BERRY_FIRMNESS, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  listBerryFlavors(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.BERRY_FLAVOR, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
};
...
var M2 = class extends o2 {
  async getContestTypeByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.CONTEST_TYPE}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getContestEffectById(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.CONTEST_EFFECT}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  async getSuperContestEffectById(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.SUPER_CONTEST_EFFECT}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  async listContestTypes(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.CONTEST_TYPE, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listContestEffects(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.CONTEST_EFFECT, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listSuperContestEffects(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.SUPER_CONTEST_EFFECT, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
};
...
var C2 = class extends o2 {
  async getEncounterMethodByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.ENCOUNTER_METHOD}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getEncounterConditionById(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.ENCOUNTER_CONDITION}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getEncounterConditionValueByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.ENCOUNTER_CONDITION_VALUE}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async listEncounterMethods(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.ENCOUNTER_METHOD, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listEncounterConditions(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.ENCOUNTER_CONDITION, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listEncounterConditionValues(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.ENCOUNTER_CONDITION_VALUE, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
};
...
var U2 = class extends o2 {
  async getEvolutionChainById(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.EVOLUTION_CHAIN}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  async getEvolutionTriggerById(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.EVOLUTION_TRIGGER}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async listEvolutionChains(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.EVOLUTION_CHAIN, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listEvolutionTriggers(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.EVOLUTION_TRIGGER, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
};
...
var y2 = class extends o2 {
  async getGenerationByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.GENERATION}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getPokedexByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.POKEDEX}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getVersionByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.VERSION}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getVersionGroupByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.VERSION_GROUP}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async listGenerations(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.GENERATION, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listPokedexes(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.POKEDEX, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listVersions(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.VERSION, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listVersionGroups(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.VERSION_GROUP, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
};
...
var u2 = class extends o2 {
  async getItemByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.ITEM}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getItemAttributeByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.ITEM_ATTRIBUTE}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getItemCategoryByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.ITEM_CATEGORY}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getItemFlingEffectByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.ITEM_FLING_EFFECT}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getItemPocketByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.ITEM_POCKET}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async listItems(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.ITEM, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listItemAttributes(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.ITEM_ATTRIBUTE, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listItemCategories(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.ITEM_CATEGORY, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listItemFilingEffects(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.ITEM_FLING_EFFECT, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listItemPockets(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.ITEM_POCKET, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
};
...
var d2 = class extends o2 {
  async getLocationByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.LOCATION}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getLocationAreaByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.LOCATION_AREA}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getPalParkAreaByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.PALPARK_AREA}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getRegionByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.REGION}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async listLocations(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.LOCATION, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listLocationAreas(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.LOCATION_AREA, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listPalParkAreas(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.PALPARK_AREA, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listRegions(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.REGION, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
};
...
var B2 = class extends o2 {
  async getMachineById(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.MACHINE}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  async listMachines(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.MACHINE, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
};
...
var G2 = class extends o2 {
  async getMoveByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.MOVE}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getMoveAilmentByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.MOVE_AILMENT}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getMoveBattleStyleByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.MOVE_BATTLE_STYLE}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getMoveCategoryByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.MOVE_CATEGORY}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getMoveDamageClassByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.MOVE_DAMAGE_CLASS}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getMoveLearnMethodByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.MOVE_LEARN_METHOD}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getMoveTargetByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.MOVE_TARGET}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async listMoves(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.MOVE, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listMoveAilments(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.MOVE_AILMENT, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listMoveBattleStyles(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.MOVE_BATTLE_STYLE, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listMoveCategories(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.MOVE_CATEGORY, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listMoveDamageClasses(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.MOVE_DAMAGE_CLASS, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listMoveLearnMethods(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.MOVE_LEARN_METHOD, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listMoveTargets(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.MOVE_TARGET, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
};
...
var D2 = class extends o2 {
  async getAbilityByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.ABILITY}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getCharacteristicById(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.CHARACTERISTIC}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  async getEggGroupByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.EGG_GROUP}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getGenderByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.GENDER}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getGrowthRateByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.GROWTH_RATE}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getNatureByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.NATURE}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getPokeathlonStatByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.POKEATHLON_STAT}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getPokemonByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.POKEMON}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getPokemonLocationAreaById(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.POKEMON_LOCATION_AREA.replace(":id", e3.toString())}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  async getPokemonColorByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.POKEMON_COLOR}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getPokemonFormByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.POKEMON_FORM}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getPokemonHabitatByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.POKEMON_HABITAT}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getPokemonShapeByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.POKEMON_SHAPE}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getPokemonSpeciesByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.POKEMON_SPECIES}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getStatByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.STAT}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async getTypeByName(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.TYPE}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  async listAbilities(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.ABILITY, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listCharacteristics(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.CHARACTERISTIC, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listEggGroups(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.EGG_GROUP, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listGenders(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.GENDER, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listGrowthRates(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.GROWTH_RATE, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listNatures(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.NATURE, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listPokeathlonStats(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.POKEATHLON_STAT, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listPokemons(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.POKEMON, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listPokemonColors(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.POKEMON_COLOR, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listPokemonForms(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.POKEMON_FORM, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listPokemonHabitats(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.POKEMON_HABITAT, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listPokemonShapes(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.POKEMON_SHAPE, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listPokemonSpecies(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.POKEMON_SPECIES, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listStats(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.STAT, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
  async listTypes(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.TYPE, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
};
...
var $2 = class extends o2 {
  async getLanguageById(e3) {
    return new Promise((a2, E2) => {
      this.api.get(`${n3.LANGUAGE}/${e3}`).then((t3) => a2(t3.data)).catch((t3) => E2(t3));
    });
  }
  ...
  listLanguages(e3, a2) {
    return new Promise((E2, t3) => {
      let r4 = this.getListURL(n3.LANGUAGE, e3, a2);
      this.api.get(r4).then((s3) => E2(s3.data)).catch((s3) => t3(s3));
    });
  }
};
